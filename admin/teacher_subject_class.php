...
<html lang="en">
  <head>
    ...
    <title>Teacher Subject Class</title>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="table-action">
                            <a href="teacher_class_grading.php?classMasterId=<?= $result[$i]['classMasterId'] ?>&subjectId=<?= $result[$i]['subjectId'] ?>&quarter=<?= $q ?>" ><i class="fa fa-pencil"></i></a>
                        </td>
                        <?php } ?>
                    </tr>
                    <?php } ?>
