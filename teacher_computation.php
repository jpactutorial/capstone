									...
									<tbody>
										...
										<tr>
											...
											<td class="table-action">
												<a href="#" data-toggle="modal" data-target="#modalData" onclick="showModalData('edit','<?= $result[$i]['computationMasterId'] ?>','<?= $result[$i]['description'] ?>','<?= $result[$i]['status'] ?>')"><i class="align-middle" data-feather="edit-2"></i></a>
												<a href="#"><i class="align-middle" data-feather="trash"></i></ad
											</td>
										</tr>
                                        <?php } ?>
									</tbody>
                            ...
                            <table class="table table-striped table-hover" id="usersTable">
									...
									<tbody>
										...
										<tr>
											...
											<td><?= $result[$i]['status'] ?></td>
											<td class="table-action">
												<a href="#" data-toggle="modal" data-target="#modalDataItems" onclick="showModalDataItems('edit','<?= $result[$i]['computationItemsId'] ?>','<?= $result[$i]['computationMasterId'] ?>','<?= $result[$i]['description'] ?>','<?= $result[$i]['percentage'] ?>','<?= $result[$i]['status'] ?>','<?= $result[$i]['total_exams'] ?>')"><i class="align-middle" data-feather="edit-2"></i></a>
